...
mod tests {
    ...
    fn v1_chunk_type_filter_values_cover_public_aliases_and_raw_types() {
        assert_eq!(
            routes::v1::v1_chunk_type_filter_values("transcript"),
            vec!["transcript".to_string(), "transcript_line".to_string()]
        );
        assert_eq!(
            routes::v1::v1_chunk_type_filter_values("visual"),
            vec![
                "keyframe".to_string(),
                "image".to_string(),
                "ocr".to_string()
        ...
        assert_eq!(
            routes::v1::v1_chunk_type_filter_values("summary"),
            vec!["understanding".to_string()]
        );
        assert_eq!(
            routes::v1::v1_chunk_type_filter_values("keyframe"),
