...
import { appLocaleTag, useLang, useT, type TFunction } from "../lib/i18n";
import {
...
function normalizeSettingsSection(section?: string | null): SettingsSection {
  ...
  if (section === "Shortcuts" || section === "Hotkeys" || section === "快捷键") {
    return "Shortcuts";
  }
  if (section === "Models" || section === "AI" || section === "Providers" || section === "模型") {
    return "Models";
  }
