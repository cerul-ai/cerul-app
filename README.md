...
Cerul App is in alpha. Current release: **0.0.62**. The foundation works end to end, and the release workflow now gates public macOS artifacts on signing, notarization, and installed-build smoke coverage.
