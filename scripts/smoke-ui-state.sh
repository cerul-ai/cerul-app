...
echo "ui_state_smoke store=electron_desktop_store fallback=localStorage last_route=persisted chunk_route=persisted onboarding_completed=persisted close_to_tray=native"
